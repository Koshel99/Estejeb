...
urlpatterns = [
    ...
    path('organizations/<int:pk>/', views.organization_profile, name='organization-profile'),
    ...
    # Volunteer
    path('volunteer/profile/<int:pk>/', views.volunteer_profile, name='volunteer-profile'),
    path('volunteers/', views.view_all_volunteers, name='view_all_volunteers'),
    path('volunteer/edit/<int:id>/', views.volunteer_edit, name='volunteer-edit'),
    path('volunteer/profile/<int:pk>/delete/', views.volunteer_delete, name='volunteer-delete'),
    ...
    path('opportunities/<int:pk>/mark-as-filled/', views.mark_as_filled, name='mark-as-filled'),
