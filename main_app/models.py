...
class VolunteerProfile(models.Model):
    ...
    photo = models.ImageField(upload_to='volunteers/%Y/%m/%d/', null=True, blank=True)
...
class Application(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='user_applications')  # Removed default=1
    volunteer = models.ForeignKey(VolunteerProfile, on_delete=models.CASCADE, related_name='volunteer_applications')  # Removed default=1
